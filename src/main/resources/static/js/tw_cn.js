...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let targetEncoding =
  optLocal.get(targetEncodingCookie) === undefined
    ? defaultEncoding
    : Number(optLocal.get('translate-chn-cht'))
  ...
  function translatePage () {
    if (targetEncoding === 1) {
      ...
      optLocal.set(targetEncodingCookie, targetEncoding, 2)
      translateBody()
      if (isSnackbar) btf.snackbar.show(snackbarData.cht_to_chs)
      ...
      optLocal.set(targetEncodingCookie, targetEncoding, 2)
      translateBody()
      if (isSnackbar) btf.snackbar.show(snackbarData.chs_to_cht)
    }
  }
  function JTPYStr () {
